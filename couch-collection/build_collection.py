...
# Visual proportions are estimated from product references, not manufacturing measurements.
configs=[
('glostad',1.96,.78,.78,.07,.19,3,(.12,.135,.15),'slim'),
('uppland',2.24,.95,.92,.22,.055,3,(.36,.42,.34),'rolled'),
('stockholm',2.50,1.02,.80,.22,.15,2,(.72,.66,.53),'wood'),
('klippan',1.80,.88,.68,.16,.14,1,(.29,.31,.32),'compact'),
('hyltarp',2.32,.93,.91,.19,.035,1,(.77,.75,.69),'skirt'),
('gullvalla',2.08,.88,.82,.17,.16,2,(.27,.39,.32),'round'),
('morabo',2.06,.92,.81,.12,.17,2,(.24,.30,.28),'tuft'),
('finnala',2.52,.98,.85,.20,.07,3,(.43,.19,.07),'leather'),
('lillesaeter',2.24,.91,.76,.22,.035,1,(.77,.73,.63),'curved'),
('mannarp',2.46,.90,.86,.12,.14,3,(.53,.47,.37),'chaise')]
...
for idx,(slug,w,d,h,arm,leg,count,color,style) in enumerate(configs):
 ...
 scene['Reference']=refs[idx]['url'];scene['Notes']='Unofficial simplified visual reconstruction; approximate scale and proportions. Not an IKEA CAD asset.'
 ...
 scene.render.engine='CYCLES';scene.cycles.samples=24;scene.cycles.use_denoising=True;scene.render.resolution_x=1000;scene.render.resolution_y=750;scene.render.resolution_percentage=100

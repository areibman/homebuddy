...
export default function Decorate(){
 ...
 if(!home)return <main style={{padding:32}}><h1>Home not found</h1><Link href="/homes">Back to your homes</Link></main>;
 if(!isPlayable(home))return <main style={{padding:32}}><h1>This home isn’t playable yet</h1><p>Its explorable interior is not available.</p><Link href="/homes">Back to your homes</Link></main>;

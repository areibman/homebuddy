...
try {
  ...
  await page.getByRole('button', { name: 'Decorate this home', exact: true }).waitFor();
  ...
  await page.getByRole('button', { name: 'Decorate this home', exact: true }).click();
  await page.waitForURL(base + '/decorate');
  ...
  await page.getByRole('button', { name: 'Close floor plan', exact: true }).click();
